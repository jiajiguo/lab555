...
public class DataBaseHandler2 extends SQLiteOpenHelper {
    ...
    Foto getContact(int id) {
        ...
        Foto contact = new Foto(Integer.parseInt(cursor.getString(0)),
    ...
    public List<Foto> getAllContacts() {
        List<Foto> contactList = new ArrayList<Foto>();
        // Select All Query
